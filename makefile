...
clean:
	rm -rf $(OBJS_CONSOLE) $(OBJS_TERM) $(OBJS_COMPUTER) $(OBJS_CHARS) $(OBJS_KEY) $(OBJS_ASSM) $(OBJS_BAS) $(LIBTERMPATH) $(LIBCOMPUTERPATH) $(LIBCHARSPATH) $(LIBKEYPATH) $(CONSOLE_EXE) $(FONT_EXE) $(SAT_EXE)